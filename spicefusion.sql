...
(3, 'limxingyi', 'limxingyi1215@gmail.com', '$2y$10$OnbrLkiwgJ9QGXonv36pE.WAzkGhqmIvV39zKaH6M3hSjXHlLMKby', 'lim', 'xing yi', '01126261230', '2000-01-21', 'Male', 'user.jpg', 1, 0, NULL, NULL, '2025-12-20 02:04:41', '2025-12-20 02:04:41', NULL, NULL),
(4, 'limxingyi2', 'limxingyi2626@gmail.com', '$2y$10$yQWiSaKEJoo/9CHtkl8T4OxqBEuAuTGj5ZLlUYLxY2PYsz3pJQMJy', 'lim2', 'xing yi2', '01122330000', '2000-10-20', 'Female', 'user.jpg', 1, 0, NULL, NULL, '2025-12-31 01:52:43', '2025-12-31 01:52:43', NULL, NULL),
(5, 'limxingyi3', 'limxingyi1230@gmail.com', '$2y$10$U/iqmJM1KBfSBPh3Bek/WuwqApeOw.nkHhw1orog1gEtSC4FWqlGS', 'lim3', 'xing yi3', '0119961230', '2010-10-10', 'Male', 'user.jpg', 1, 0, NULL, NULL, '2025-12-31 01:54:13', '2025-12-31 01:54:13', NULL, NULL);
...
--
-- 使用表AUTO_INCREMENT `delivery_address`
--
ALTER TABLE `delivery_address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用表AUTO_INCREMENT `dummy_bank`
--
ALTER TABLE `dummy_bank`
...
--
-- 使用表AUTO_INCREMENT `security_questions`
--
ALTER TABLE `security_questions`
